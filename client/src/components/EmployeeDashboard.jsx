    ...
    <section className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
      {cards.map((card, index) => (
        ...
        >
          ...
          <card.icon className="size-10 p-2.5 rounded-lg bg-slate-100 text-slate-600 border border-transparent group-hover:border-slate-300 group-hover:bg-slate-50 transition-all duration-200" />
        </article>
      ))}
    </section>
