        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-2.5 rounded-md text-sm hover:bg-slate-800 font-semibold disabled:opacity-50 transition-all duration-200 shadow-lg active:scale-[0.98] flex items-center justify-center cursor-pointer"
            >
